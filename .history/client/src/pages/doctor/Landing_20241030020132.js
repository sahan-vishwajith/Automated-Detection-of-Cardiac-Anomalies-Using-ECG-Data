...
import icon1 from './photos/calendar_16290939.png'; // Import your icon here
import icon2 from './photos/target_10634893.png';
import icon3 from './photos/doctor_4131330.png';
import icon4 from './photos/patient_15090791.png';
...
=======
                                    <StatsCard title="Total registered patient" value="2,390" percentage={4.7} icon={icon4}/>
                                </div>
                                <div style={styles.statsCard}>
                                    <StatsCard title="Total registered doctors" value="320" percentage={1.5} icon={icon3}/>
>>>>>>> 94b292e (commit msg)
                                </div>
                            </div>
                            <div style={styles.row}>
...
=======
                                    <StatsCard title="Prediction Accuracy" value="99.97%" percentage={0.1} icon={icon2}/>
>>>>>>> 94b292e (commit msg)
                                </div>
                                <div style={styles.statsCard}>
                                    <StatsCard title="Avg prediction time" value="4.6s" percentage={-2.7} icon={icon1}/>
                                </div>
                            </div>
