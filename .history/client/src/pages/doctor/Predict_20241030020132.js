...
=======
            <Card sx={{ height:"750px",width: '80%', maxWidth: 400, maxHeight:"90%", background: 'rgba(255, 255, 255, 0.8)', borderRadius: '16px', boxShadow: '0 4px 30px rgba(0, 0, 0, 0.1)', backdropFilter: 'blur(5px)', border: '1px solid rgba(33, 137, 228, 0.34)' }}>
            <CardMedia
  component="img"
  height="230"
  image={patientimg}
...
>>>>>>> 94b292e (commit msg)
        ...
        <Grid item xs={12} md={6}>
          <Box sx={{height:"600px",  display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '80%', maxWidth: 400,
            backgroundColor: 'rgba(255, 255, 255, 0.8)',
            borderRadius: '8px',
            margin:'50px', // Optional: add some border radius for better aesthetics
            padding: '20px', }}>
            <TextField
              type="file"
              name="atr"
