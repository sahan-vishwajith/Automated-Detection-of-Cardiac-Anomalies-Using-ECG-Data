...
// Example usage
const density = 5; // Example density value
const maxDensity = 10; // Example maximum density
const color = generateColorByDensity(density, maxDensity);
console.log(color); // Outputs a color based on the density
