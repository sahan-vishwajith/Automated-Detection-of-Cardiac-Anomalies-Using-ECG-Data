...
const getColor = (feature , locationCounts) => {
  console.log(locationCounts.Badulla)
  const totalCount = Object.values(locationCounts).reduce((acc, count) => acc + count, 0);
  switch (feature.properties.name) {
    case 'Trikuṇāmalaya':
      return generateColorByDensity(locationCounts.Badulla ,5); // Color for Trikuṇāmalaya
    case 'Mulativ':
      return generateColorByDensity(locationCounts.Badulla ,5); // Color for Mulativ
    case 'Yāpanaya':
